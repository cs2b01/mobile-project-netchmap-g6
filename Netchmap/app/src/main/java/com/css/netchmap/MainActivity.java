...
public class MainActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        TextView txtName = findViewById(R.id.name_fullname);
        txtName.append(getIntent().getExtras().get("name") + " " + getIntent().getExtras().get("fullname"));
        txtUsername.append("@" + getIntent().getExtras().get("username"));
        return true;
    }
